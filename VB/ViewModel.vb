		...
		Public Sub New()
			...
			For i As Integer = 0 To 49
				Dim item1 As New Item() With {
					.Id = i,
					.Name = String.Format("Item_{0}", i)
				}
				For j As Integer = 0 To 9
					Dim item2 As New Item() With {
						.Id = j,
						.Name = String.Format("Item_{0}.{1}", i, j)
					}
					For k As Integer = 0 To 4
						item2.Items.Add(New Item() With {
							.Id = k,
							.Name = String.Format("Item_{0}.{1}.{2}", i, j, k)
						})
					Next k
